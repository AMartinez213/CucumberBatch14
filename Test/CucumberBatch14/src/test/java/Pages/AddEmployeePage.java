...
public class AddEmployeePage extends CommonsMethods {
...
//        page factory is the concept of selenium which we use to implement page object model design pattern which is responsible to initialize all the objects
